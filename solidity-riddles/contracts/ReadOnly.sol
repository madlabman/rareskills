...
contract ReadOnlyAttacker {
    ...
    function attack(ReadOnlyPool pool, VulnerableDeFiContract v) external {
        victim = v;
    ...
    receive() external payable {
        // At this point pool.balance will be decreased but the totalSupply is not yet updated.
